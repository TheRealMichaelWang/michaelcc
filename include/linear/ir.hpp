...
namespace michaelcc {
	namespace linear {
        ...
        enum a_instruction_type {
            MICHAELCC_LINEAR_A_ADD, MICHAELCC_LINEAR_A_SUBTRACT, 
            
            MICHAELCC_LINEAR_A_SIGNED_MULTIPLY, MICHAELCC_LINEAR_A_UNSIGNED_MULTIPLY,
            MICHAELCC_LINEAR_A_SIGNED_DIVIDE, MICHAELCC_LINEAR_A_UNSIGNED_DIVIDE, 
            MICHAELCC_LINEAR_A_SIGNED_MODULO, MICHAELCC_LINEAR_A_UNSIGNED_MODULO,

            MICHAELCC_LINEAR_A_SHIFT_LEFT, MICHAELCC_LINEAR_A_SIGNED_SHIFT_RIGHT, MICHAELCC_LINEAR_A_UNSIGNED_SHIFT_RIGHT, 
            MICHAELCC_LINEAR_A_BITWISE_AND, MICHAELCC_LINEAR_A_BITWISE_OR, MICHAELCC_LINEAR_A_BITWISE_XOR, MICHAELCC_LINEAR_A_BITWISE_NAND,
            
            MICHAELCC_LINEAR_A_AND, MICHAELCC_LINEAR_A_OR, MICHAELCC_LINEAR_A_XOR,
        ...
        enum c_instruction_type {
            MICHAELCC_LINEAR_C_FLOAT64_TO_SIGNED_INT64,
            MICHAELCC_LINEAR_C_FLOAT64_TO_UNSIGNED_INT64,
            MICHAELCC_LINEAR_C_FLOAT32_TO_SIGNED_INT32,
            MICHAELCC_LINEAR_C_FLOAT32_TO_UNSIGNED_INT32,
            MICHAELCC_LINEAR_C_SIGNED_INT64_TO_FLOAT64,
            MICHAELCC_LINEAR_C_UNSIGNED_INT64_TO_FLOAT64,
            MICHAELCC_LINEAR_C_SIGNED_INT32_TO_FLOAT32,
            MICHAELCC_LINEAR_C_UNSIGNED_INT32_TO_FLOAT32,

            MICHAELCC_LINEAR_C_FLOAT32_TO_FLOAT64,
