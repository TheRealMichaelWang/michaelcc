...
namespace michaelcc {
	namespace logical_ir {
		...
		private:
            ...
            std::shared_ptr<typing::type> m_type;
			bool m_is_global;
		public:
			variable(std::string&& name, std::shared_ptr<typing::type>&& var_type, bool is_global, std::weak_ptr<symbol_context>&& context)
				: symbol(std::move(name), std::move(context)), m_type(std::move(var_type)), m_is_global(is_global) {}

			const std::shared_ptr<typing::type> get_type() const noexcept { return m_type; }
		...
		public:
			...
			virtual const std::shared_ptr<typing::type> get_type() const = 0;
		...
		private:
			uint64_t m_value;
			std::shared_ptr<typing::int_type> m_type;
		public:
			integer_constant(uint64_t value, std::shared_ptr<typing::int_type>&& int_type)
				: m_value(value), m_type(std::move(int_type)) {}

			uint64_t value() const noexcept { return m_value; }
			
            const std::shared_ptr<typing::type> get_type() const override { 
                return m_type; 
            }
		...
		private:
			double m_value;
			std::shared_ptr<typing::float_type> m_type;
		public:
			floating_constant(double value, std::shared_ptr<typing::float_type>&& float_type)
		...
		public:
			...
			const std::shared_ptr<typing::type> get_type() const override { 
                return std::make_shared<typing::pointer_type>(std::make_shared<typing::int_type>(0, typing::CHAR_INT_CLASS)); 
            }
		...
		private:
            ...
            std::shared_ptr<typing::type> m_result_type;
		public:
			binary_operation(token_type op,
				std::unique_ptr<expression>&& left,
				std::unique_ptr<expression>&& right,
				std::shared_ptr<typing::type>&& result_type)
				: m_operator(op),
            ...
            const std::shared_ptr<typing::type> get_type() const override { return m_result_type; }
		...
		public:
            ...
            const std::shared_ptr<typing::type> get_type() const override { return m_operand->get_type(); }
		...
		private:
			std::unique_ptr<expression> m_operand;
			std::shared_ptr<typing::type> m_target_type;
		public:
			type_cast(std::unique_ptr<expression>&& operand, std::shared_ptr<typing::type>&& target_type)
				: m_operand(std::move(operand)), m_target_type(std::move(target_type)) {}

			const expression* operand() const noexcept { return m_operand.get(); }
			const std::shared_ptr<typing::type> get_type() const override { return m_target_type; }
		...
		public:
			...
			const std::shared_ptr<typing::type> get_type() const override { 
                return std::make_shared<typing::pointer_type>(m_operand->get_type());
            }
		...
		public:
			...
			const std::shared_ptr<typing::type> get_type() const override {
				...
				return ptr_type ? ptr_type->pointee_type() : nullptr;
			}
		...
		private:
			...
			std::shared_ptr<typing::type> m_field_type; 
		public:
			member_access(std::unique_ptr<expression>&& base, size_t field_index, std::shared_ptr<typing::type>&& field_type)
			...
			const std::shared_ptr<typing::type> get_type() const override { return m_field_type; }
		...
		public:
			...
			const std::shared_ptr<typing::type> get_type() const override {
				...
				auto* arr_type = dynamic_cast<const typing::array_type*>(base_type.get());
				if (arr_type != nullptr) {
					return arr_type->element_type();
				}
				auto* ptr_type = dynamic_cast<const typing::pointer_type*>(base_type.get());
				return ptr_type ? std::make_shared<typing::pointer_type>(ptr_type->pointee_type()) : nullptr;
			}
		...
		public:
			...
			const std::shared_ptr<typing::type> get_type() const override {
				...
				auto* ptr_type = dynamic_cast<const typing::pointer_type*>(callee_type.get());
				if (ptr_type != nullptr) {
					return ptr_type->pointee_type();
				}
				auto* fn_type = dynamic_cast<const typing::function_pointer_type*>(callee_type.get());
				return fn_type ? fn_type->return_type() : nullptr;
			}
