...
namespace michaelcc {
	namespace ast {
        ...
        class type_specifier final : public visitable_base<type_specifier, visitor, ast_element> {
        private:
        ...
        public:
            explicit type_specifier(std::vector<token_type>&& type_keywords, source_location&& location)
                : visitable_base(std::move(location)), m_type_keywords(std::move(type_keywords)) {}
        ...
        class qualified_type final : public visitable_base<qualified_type, visitor, ast_element> {
        private:
        ...
        public:
            qualified_type(uint8_t qualifiers, std::unique_ptr<ast_element>&& inner_type, source_location&& location)
                : visitable_base(std::move(location)), m_qualifiers(qualifiers), m_inner_type(std::move(inner_type)) {}
        ...
        class derived_type final : public visitable_base<derived_type, visitor, ast_element> {
        public:
        ...
        public:
            explicit derived_type(std::unique_ptr<ast_element>&& inner_type, source_location&& location)
                : visitable_base(std::move(location)), m_kind(kind::POINTER), 
            ...
            derived_type(std::unique_ptr<ast_element>&& inner_type, 
                ...
                : visitable_base(std::move(location)), m_kind(kind::ARRAY),
        ...
        class function_type final : public visitable_base<function_type, visitor, ast_element> {
        public:
            struct parameter {
        ...
        public:
            function_type(std::unique_ptr<ast_element>&& return_type,
                         ...
                         bool is_variadic,
                         source_location&& location)
                : visitable_base(std::move(location)), m_return_type(std::move(return_type)),
		...
		class context_block : public visitable_base<context_block, visitor, ast_element> {
		private:
		...
		public:
			explicit context_block(std::vector<std::unique_ptr<ast_element>>&& statements, source_location&& location)
				: visitable_base(std::move(location)), m_statements(std::move(statements)) { }

			context_block(context_block&& other) noexcept
				: visitable_base(source_location(other.location())), m_statements(std::move(other.m_statements)) { }
		...
		class for_loop final : public visitable_base<for_loop, visitor, ast_element> {
		private:
		...
		public:
			for_loop(std::unique_ptr<ast_element>&& initial_statement,
				...
				: visitable_base(std::move(location)),
        ...
        class do_block final : public visitable_base<do_block, visitor, ast_element> {
        private:
            std::unique_ptr<ast_element> m_condition;
            context_block m_to_execute;
        ...
        class while_block final : public visitable_base<while_block, visitor, ast_element> {
        private:
            std::unique_ptr<ast_element> m_condition;
            context_block m_to_execute;
        ...
        class if_block final : public visitable_base<if_block, visitor, ast_element> {
        private:
            std::unique_ptr<ast_element> m_condition;
        ...
        class if_else_block final : public visitable_base<if_else_block, visitor, ast_element> {
        private:
            std::unique_ptr<ast_element> m_condition;
            context_block m_execute_if_true;
        ...
        class return_statement final : public visitable_base<return_statement, visitor, ast_element> {
        private:
        ...
        class break_statement final : public visitable_base<break_statement, visitor, ast_element> {
        private:
            int m_loop_depth;
        ...
        class continue_statement final : public visitable_base<continue_statement, visitor, ast_element> {
        private:
            int m_loop_depth;

        public:
            explicit continue_statement(int depth, source_location&& location)
                : visitable_base(std::move(location)), m_loop_depth(depth) {}
        ...
        class int_literal final : public visitable_base<int_literal, visitor, ast_element> {
        private:
            int64_t m_value;

        public:
            explicit int_literal(int64_t value, source_location&& location)
                : visitable_base(std::move(location)), m_value(value) {}
        ...
        class float_literal final : public visitable_base<float_literal, visitor, ast_element> {
        private:
            float m_value;
        ...
        class double_literal final : public visitable_base<double_literal, visitor, ast_element> {
        private:
            double m_value;
        ...
        class string_literal final : public visitable_base<string_literal, visitor, ast_element> {
        private:
            std::string m_value;
        public:
            explicit string_literal(std::string value, source_location&& location)
                : visitable_base(std::move(location)), m_value(std::move(value)) {}
        ...
        class variable_reference final : public visitable_base<variable_reference, visitor, ast_element> {
        private:
            std::string m_identifier;

        public:
            explicit variable_reference(const std::string& identifier, source_location&& location)
                : visitable_base(std::move(location)), m_identifier(identifier) {}
        ...
        class get_index final : public visitable_base<get_index, visitor, ast_element> {
        private:
        ...
        class get_property final : public visitable_base<get_property, visitor, ast_element> {
        private:
        ...
        class set_operator final : public visitable_base<set_operator, visitor, ast_element> {
        private:
        ...
        class dereference_operator final : public visitable_base<dereference_operator, visitor, ast_element> {
        private:
        ...
        class get_reference final : public visitable_base<get_reference, visitor, ast_element> {
        private:
        ...
        class arithmetic_operator final : public visitable_base<arithmetic_operator, visitor, ast_element> {
        private:
        ...
        class conditional_expression final : public visitable_base<conditional_expression, visitor, ast_element> {
        private:
            std::unique_ptr<ast_element> m_condition;
        ...
        class function_call : public visitable_base<function_call, visitor, ast_element> {
        private:
        ...
        class initializer_list_expression : public visitable_base<initializer_list_expression, visitor, ast_element> {
        private:
        ...
        public:
            explicit initializer_list_expression(std::vector<std::unique_ptr<ast_element>>&& initializers, source_location&& location)
                : visitable_base(std::move(location)), m_initializers(std::move(initializers)) {}
        ...
        class variable_declaration final : public visitable_base<variable_declaration, visitor, ast_element> {
        private:
            uint8_t m_qualifiers;
        ...
        class typedef_declaration final : public visitable_base<typedef_declaration, visitor, ast_element> {
        private:
            std::unique_ptr<ast_element> m_type;
            std::string m_name;
        ...
        class struct_declaration final : public visitable_base<struct_declaration, visitor, ast_element> {
        private:
        ...
        class enum_declaration final : public visitable_base<enum_declaration, visitor, ast_element> {
        public:
            struct enumerator {
                std::string name;
        ...
        class union_declaration : public visitable_base<union_declaration, visitor, ast_element> {
        public:
            struct member {
        ...
        class function_prototype : public visitable_base<function_prototype, visitor, ast_element> {
        private:
            std::unique_ptr<ast_element> m_return_type;
        ...
        class function_declaration : public visitable_base<function_declaration, visitor, ast_element> {
        private:
            std::unique_ptr<ast_element> m_return_type;
            std::string m_function_name;
            std::vector<function_parameter> m_parameters;
...
MICHAELCC_AST_NODE_INFO_LEAF(michaelcc::ast::type_specifier);
MICHAELCC_AST_NODE_INFO(michaelcc::ast::qualified_type, 
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, inner_type)
);
MICHAELCC_AST_NODE_INFO(michaelcc::ast::derived_type, 
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, inner_type),
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, array_size)
);
MICHAELCC_AST_NODE_INFO(michaelcc::ast::function_type, 
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, return_type)
);
MICHAELCC_AST_NODE_INFO_LEAF(michaelcc::ast::context_block);
MICHAELCC_AST_NODE_INFO(michaelcc::ast::for_loop,
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, initial_statement),
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, condition),
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, increment_statement),
    MICHAELCC_AST_CHILD(michaelcc::ast::context_block, body)
);
MICHAELCC_AST_NODE_INFO(michaelcc::ast::do_block, 
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, condition),
    MICHAELCC_AST_CHILD(michaelcc::ast::context_block, body)
);
MICHAELCC_AST_NODE_INFO(michaelcc::ast::while_block, 
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, condition),
    MICHAELCC_AST_CHILD(michaelcc::ast::context_block, body)
);
MICHAELCC_AST_NODE_INFO(michaelcc::ast::if_block, 
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, condition),
    MICHAELCC_AST_CHILD(michaelcc::ast::context_block, body)
);
MICHAELCC_AST_NODE_INFO(michaelcc::ast::if_else_block, 
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, condition),
    MICHAELCC_AST_CHILD(michaelcc::ast::context_block, true_body),
    MICHAELCC_AST_CHILD(michaelcc::ast::context_block, false_body)
);
MICHAELCC_AST_NODE_INFO(michaelcc::ast::return_statement, 
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, value)
);
MICHAELCC_AST_NODE_INFO_LEAF(michaelcc::ast::break_statement);
MICHAELCC_AST_NODE_INFO_LEAF(michaelcc::ast::continue_statement);
MICHAELCC_AST_NODE_INFO_LEAF(michaelcc::ast::int_literal);
MICHAELCC_AST_NODE_INFO_LEAF(michaelcc::ast::float_literal);
MICHAELCC_AST_NODE_INFO_LEAF(michaelcc::ast::double_literal);
MICHAELCC_AST_NODE_INFO_LEAF(michaelcc::ast::string_literal);
MICHAELCC_AST_NODE_INFO_LEAF(michaelcc::ast::variable_reference);
MICHAELCC_AST_NODE_INFO(michaelcc::ast::get_index,
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, pointer),
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, index));
MICHAELCC_AST_NODE_INFO(michaelcc::ast::get_property, MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, struct_expr));
MICHAELCC_AST_NODE_INFO(michaelcc::ast::set_operator,
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, destination),
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, value));
MICHAELCC_AST_NODE_INFO(michaelcc::ast::dereference_operator, MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, pointer));
MICHAELCC_AST_NODE_INFO(michaelcc::ast::get_reference, MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, item));
MICHAELCC_AST_NODE_INFO(michaelcc::ast::arithmetic_operator,
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, left),
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, right));
MICHAELCC_AST_NODE_INFO(michaelcc::ast::conditional_expression,
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, condition),
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, true_expr),
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, false_expr));
MICHAELCC_AST_NODE_INFO(michaelcc::ast::function_call, MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, callee));
MICHAELCC_AST_NODE_INFO_LEAF(michaelcc::ast::initializer_list_expression);
MICHAELCC_AST_NODE_INFO(michaelcc::ast::variable_declaration,
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, type),
    MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, set_value));
MICHAELCC_AST_NODE_INFO(michaelcc::ast::typedef_declaration, MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, type));
MICHAELCC_AST_NODE_INFO_LEAF(michaelcc::ast::struct_declaration);
MICHAELCC_AST_NODE_INFO_LEAF(michaelcc::ast::enum_declaration);
MICHAELCC_AST_NODE_INFO_LEAF(michaelcc::ast::union_declaration);
MICHAELCC_AST_NODE_INFO(michaelcc::ast::function_prototype, MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, return_type));
MICHAELCC_AST_NODE_INFO(michaelcc::ast::function_declaration, MICHAELCC_AST_CHILD(michaelcc::ast::ast_element, return_type));
